...
class Complex {
    ...
    addComplex(y) { return new Complex(this.real() + y.real(), this.imaginary() + y.imaginary()); }
    subComplex(y) { return new Complex(this.real() - y.real(), this.imaginary() - y.imaginary()); }
    modComplex() {
